...
public class EpisodeArrayAdapter extends ArrayAdapter<MVPlaylistMedia> {
	...
	public EpisodeArrayAdapter(Activity context, int textViewResourceId,
			ArrayList<MVPlaylistMedia> arrContent, String category) {
			...
			mShareButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					i.putExtra(Intent.EXTRA_SUBJECT, "[adult swim] "
							+ mMediaArray.get(Integer.valueOf(tag)).getTitle());
