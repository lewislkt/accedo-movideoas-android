...
public class MVMediaSearchRequest extends GoogleHttpClientSpiceRequest<MVMediaSearch> {
	...
	public MVMediaSearchRequest(String token, String keywords, String searchCriteria, int pages) {
